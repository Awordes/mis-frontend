<template>
  <div class="login-wr form">
    <div class="username">
      ...
      <input name="email" id="email" required v-model="username" type="text" placeholder="Пользователь" />
    </div>
    ...
    <div class="passwd">
      ...
      <input name="password" id="password" required v-model="password" type="password" placeholder="Пароль" v-on:keyup.enter="onEnter" />
    </div>
